                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <button type="button" class="btn btn-warning" onclick="window.location='<?= base_url('chef/barangkeluar'); ?>'"><i class="fa fa-arrow-left"></i> Kembali</button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <?php
                                        ...
                                        $id_penerima = $pengirimanbarang['id_penerima'];
                                        $penerima = $this->db->get_where('pegawai', ['id_penerima' => $id_penerima])->row_array();
                                        if ($id_penerima == '') {
                                    ...
                                    ?>
                                        ...
                                        <?php } ?>
                                        <a href="<?= base_url(); ?>chef/hapus_pengirimanbarang/<?= $pengirimanbarang['id_barangkeluar'] . '/' . $pengirimanbarang['id_pengirimanbarang']; ?>"><button type="button" class="btn btn-danger btn-sm mt-2" onclick="return confirm('Anda yakin ingin menghapus data ini');"><i class="fa fa-trash"></i> Hapus Pengiriman</button></a>
                                    <?php } ?>
                                </div>
                            </div>
                            <hr />
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url(); ?>chef/hapus_daftarbarangkeluar/<?= $filter['id_barangkeluar'] . '/' . $filter['id_daftarbarangkeluar']; ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini');"><i class="fa fa-trash"></i> Hapus</button></a>
                                                </td>
                                            </tr>
                                        <?php
                                            $no++;
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="formTambah" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="id_penerima" class="form-control" id="id_penerima" value="">
                                    <input type="hidden" name="id_barangkeluar" class="form-control" id="id_barangkeluar" value="<?= $barangkeluar['id_barangkeluar']; ?>">
                                    <?php
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="formTambah" action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="id_penerima">Pilih Penerima</label>
                                                <select class="form-control select2 select2-hidden-accessible" name="id_penerima" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                    <?php
                                                    $penerimalist = $this->db->get_where('pegawai', ['id_jabatan' => '100'])->result_array();
                                                    foreach ($penerimalist as $list) :
                                                    ?>
                                                        <option value="<?= $list['id_pegawai']; ?>"><?= $list['nama_pegawai']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
