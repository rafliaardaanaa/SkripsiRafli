                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <button type="button" class="btn btn-warning" onclick="window.location='<?= base_url('toko/barangkeluar'); ?>'"><i class="fa fa-arrow-left"></i> Kembali</button>
                                <a href="<?= base_url('toko/cetakbarangkeluarbyid/' . $barangkeluar['id_barangkeluar']); ?>" target="_blank"><button type="button" class="btn btn-primary ml-3"><i class="fa fa-print"></i> Cetak</button></a>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
