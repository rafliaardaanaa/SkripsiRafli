          ...
          <div class="card">
              ...
              <div class="card-body col-md-12">
                  <form id="formTambah" action="" method="post" enctype="multipart/form-data">
                      <input type="hidden" name="id_barangkeluar" class="form-control" id="id_barangkeluar" value="<?= $barangkeluar['id_barangkeluar']; ?>" readonly>
                      <div class="modal-body">
                          <div class="form-group">
                              <label for="no_faktur">No Faktur</label>
                              <input type="text" name="no_faktur" class="form-control" id="no_faktur" value="<?= $barangkeluar['no_faktur']; ?>" placeholder="Isi No Faktur">
                              <small class="text-danger"><?= form_error('no_faktur'); ?></small>
                          </div>
                          <div class="form-group">
                              <label for="tanggal_faktur">Tanggal Faktur</label>
                              <input type="date" name="tanggal_faktur" class="form-control" id="tanggal_faktur" value="<?= $barangkeluar['tanggal_faktur']; ?>" placeholder="Isi Tanggal Faktur">
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control select2 select2-hidden-accessible" name="id_toko" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                  <?php foreach ($toko as $list) :; ?>
                                      <?php
                                        if ($list['id_toko'] == $barangmasuk['id_toko']) {

                                        ?>
                                          <option value="<?= $list['id_toko']; ?>" selected="selected"><?= $list['kode'] . ' - ' . $list['nama_toko']; ?></option>
                                      <?php
                                        } else {
                                        ?>
                          ...
                          <div class="form-group">
                              ...
                              <textarea name="keterangan" class="form-control" id="keterangan" rows="5" placeholder="Isi Keterangan"><?= $barangkeluar['keterangan']; ?></textarea>
