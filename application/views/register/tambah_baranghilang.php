              ...
              <div class="card-body col-md-12">
                  <form id="formTambah" action="" method="post" enctype="multipart/form-data">
                      <div class="modal-body">
                          <?php
                            $queryKode = $this->db->query("SELECT max(kode) as kodeTerbesar FROM baranghilang")->row_array();
                            $kodebaranghilang = $queryKode['kodeTerbesar'];
                            $urutan = (int) substr($kodebaranghilang, 2, 5);
                            $urutan++;
                            $huruf = "BH";
                            $kodebaranghilang = $huruf . sprintf("%05s", $urutan);
                            ?>
                          <div class="form-group">
                              <label for="kode">Kode Barang Hilang</label>
                              <input type="hidden" name="kode" class="form-control" id="kode" value="<?= $kodebaranghilang; ?>">
                              <input type="text" name="kode1" class="form-control" id="kode1" value="<?= $kodebaranghilang; ?>" disabled>
                          ...
                          <div class="form-group">
                              ...
                              <input type="number" name="hilang" class="form-control" id="hilang" value="0" placeholder="Isi Jumlah">
