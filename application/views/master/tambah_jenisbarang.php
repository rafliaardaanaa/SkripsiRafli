                            ...
                            <div class="col-md-12">
                                <form id="formTambah" action="" method="post">
                                    <div class="modal-body">
                                        <?php
                                        $cekurutan = $this->db->query('SELECT * FROM jenisbarang ORDER BY urutan DESC');
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_jenisbarang" class="form-control" id="nama_jenisbarang" oninput="this.value=this.value.replace(/[^a-zA-Z\s.,]/g, '');" value="<?= set_value('nama_jenisbarang'); ?>" placeholder="Isi Nama Jenis Barang">
