                            ...
                            <div class="mb-3">
                                <div class="row">
                                    <div class="cols-4 mr-4">
                                        ...
                                        <a href="<?= base_url('laporan/cetakbarangrusakall'); ?>" target="_blank"><button type="button" class="btn btn-success ml-3"><i class="fa fa-print"></i> Cetak Semua</button></a>
                                    </div>
                                    <div class="cols-4">
                                        <?php if (($this->session->flashdata()) and (isset($daritanggal))) : ?>
                                            <form id="formTambah" action="<?= base_url('laporan/cetakbarangrusak'); ?>" method="post" target="_blank">
